class Participants():
    ...
    def is_valid_name(name) :
        if name.isalpha() and len(name) > Participants.MINIMUM_NAME_LENGTH \
        and len(name) < Participants.MAXIMUM_NAME_LENGTH:
            return True
        else:
    ...
    def is_valid_length(the_participants) :    
        ...
        # If we reached thParticipantsis point then the checks passed
        return True

class ChoresList:
    ...
    # Check the list of chores is of valid length.
    #
    # @param the_chores, all the chores
    # @return True if the set conforms to the validation conditions
    #         and raise exception if it does not.
    #
    @staticmethod
    ...
    # Check the chores are instances of the Chore class.
    #
    # @param the_chores, all the chores
    # @return True if the set conforms to the validation conditions
    #         and raise exception if it does not.
...
class Chore:
    ...
    def __eq__(self, other_chore):
        if isinstance(other_chore, Chore):
            return self.chore_name == other_chore.chore_name
        else:
    ...
    # characters and check that it is the right length.
    # 
    ...
    #  Checks whether the chore frequency is greater than or
    ...
    def is_valid_frequency(frequency):
        ...
        if frequency < Chore.MINIMUM_CHORE_FREQUENCY or frequency > Chore.MAXIMUM_CHORE_FREQUENCY:
            raise ValueError(("Chore frequency must be greater or equal to " + "{} and less than or equal to {}")
